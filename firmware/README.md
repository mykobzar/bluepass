...
| File | Flash address | Description |
|---|---|---|
| `bootloader-2.1.12.bin` | `0x0` | Second-stage bootloader |
| `partition-table-2.1.12.bin` | `0x8000` | Partition layout (NVS + dual OTA slots) |
...
| File | Flash address | Description |
|---|---|---|
| `bootloader-2.1.12-enc.bin` | `0x0` | Bootloader with encryption support |
