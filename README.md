...
esptool.py --chip esp32s3 --port /dev/ttyUSB0 --baud 460800 write_flash \
  ...
  0x0     firmware/bootloader-2.1.1.bin \
  0x8000  firmware/partition-table-2.1.1.bin \
  0x10000 firmware/ota_data_initial-2.1.1.bin \
  0x20000 firmware/bluepass-2.1.1.bin
